  ...
  <?php
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<p class='order_details_id'>Order ID: " . $row["orderID"] . "</p>";
              echo "<p class='order_details_date'>Date: " . $row["Date/Time"] . "</p>";
              echo "<p class='order_details_items'>Items: " . $row["Items"] . "</p>";
              echo "<p class='order_details_cost'>Total: ₹" . $row["Total_Cost"] . "</p>";
              echo "<p class='order_details_status $statusClass'>Status: " . $row["Status"] . "</p>";
              echo "</div>";
              echo "<hr>";
          }
      } else {
          echo "<p  class='orders_details'>No orders found.</p>";
      }
      $con->close();
?>
</div>
